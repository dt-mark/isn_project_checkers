...
def aiGain(aiPlayer):
    ...
    bestmoves = list()
    for token in onePlayerCanMove[aiPlayer][1:]:
        ...
        for move in possibleMoves:
            ...
            if (not empty(move[0]-aiPlayer, move[1]+aiPlayer) and players[move[0]-aiPlayer][move[1]+aiPlayer].type == -aiPlayer) \
                    or (not empty(move[0]+aiPlayer, move[1]+aiPlayer) and players[move[0]+aiPlayer][move[1]+aiPlayer].type == -aiPlayer):
                tempgain += -1
